...
final class ParentPage {
	...
	public static function get_plugins_registry(): array {
		return [
			'lw-seo'          => [
				'name'          => 'LW SEO',
				'description'   => __( 'Essential SEO features without the bloat.', 'lw-lms' ),
			...
			'lw-disable'      => [
				'name'          => 'LW Disable',
				'description'   => __( 'Disable WordPress features.', 'lw-lms' ),
			...
			'lw-site-manager' => [
				...
				'description'   => __( 'Site maintenance via AI/REST.', 'lw-lms' ),
			...
			'lw-s3'           => [
				'name'          => 'LW S3',
				'description'   => __( 'S3 media offload for Kubernetes.', 'lw-lms' ),
			...
			'lw-memberships'  => [
				'name'          => 'LW Memberships',
				'description'   => __( 'Membership system with WooCommerce.', 'lw-lms' ),
			...
			'lw-lms'          => [
				'name'          => 'LW LMS',
				'description'   => __( 'Courses, lessons, and progress tracking.', 'lw-lms' ),
	...
	public static function render(): void {
		...
		<div class="wrap lw-plugins-overview">
			<h1><?php esc_html_e( 'LW Plugins', 'lw-lms' ); ?></h1>
			<p><?php esc_html_e( 'Lightweight plugins for WordPress.', 'lw-lms' ); ?></p>
	...
	private static function render_plugin_card( string $slug, array $plugin ): void {
		...
		<div class="lw-plugin-card" style="background: #fff; border: 1px solid #ccd0d4; border-radius: 4px; padding: 20px; width: 300px;">
			<h2 style="margin-top: 0;">
				...
				<?php if ( $is_active ) : ?>
					<span style="display: inline-block; background: #00a32a; color: #fff; font-size: 11px; padding: 2px 6px; border-radius: 3px; margin-left: 8px; vertical-align: middle;"><?php esc_html_e( 'Active', 'lw-lms' ); ?></span>
				<?php endif; ?>
			</h2>
